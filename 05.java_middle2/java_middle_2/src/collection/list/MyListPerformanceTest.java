...
public class MyListPerformanceTest {
    public static void main(String[] args) {
        ...
        MyArrayList<Integer> arrayList = new MyArrayList<>(); //조회용으로 사용
        ...
        MyLinkedList<Integer> linkedList = new MyLinkedList<>();//조회용으로 사용
    ...
    private static void addMid(MyList<Integer> list , int size) {
        ...
        long endTime = System.currentTimeMillis();
        System.out.println("중앙에 추가 - 크기 : " + size + ", 계산시간 :" + (endTime - startTime) + " ms");
